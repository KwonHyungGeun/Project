...
<link rel="stylesheet" href="resources/css/england.css">
...
<script type="text/javascript">
	...
	<title> Soccer Chart - France </title>
</head>
	...
	<body>
        ...
        <div id="loading">
            ...
            <div id="englandcontent">
                <div id="englandlogo">
                    <h1>France Ligue 1</h1>
                    <div id="logo">
                        <img src="resources/css/img/francelogo.png">
                    </div>
                    <div id="explain">
                        <p>    France League1입니다.</p>
